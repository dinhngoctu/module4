...
//    }
    ...
    public DataSource dataSource() {
        ...
        dataSource.setUrl("Jdbc:mysql://52.187.177.166:3306/data1?serverTimezone=UTC&useUnicode=yes&characterEncoding=UTF-8");
...
//        messageSource.setBasenames("/WEB-INF/classes/message");
    ...
    @Bean
    public ICateService cateService() {
        return new CateSerive();
    }
}
